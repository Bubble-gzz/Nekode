...
public class Puzzle3_5 : PuzzleLogic
{
   protected override void Awake()
    ...
    override protected void Start()
    {
        ...
        conditions[0] = "TRIPLE ! TRIPLE ! TRIPLE!";
        conditions[1] = "TRIPLE ! TRIPLE ! TRIPLE!";
        conditions[2] = "TRIPLE ! TRIPLE ! TRIPLE!";
    ...
    override protected IEnumerator GameProcess()
    {
        ...
        if (Settings.language == "CH") dialogue.Play("今天我们来做三倍放大器！");
        else dialogue.Play("Today let's make a triple amplifier!", new Vector2(720, 120));
        ...
        if (Settings.language == "CH") SetTarget("B=A*3");
        else SetTarget("B=A*3");
    ...
    public override void GenerateTestCase()
    {
        ...
        {
            grid.tileTable["A"][0].UpdateValue(4);      
        }
       ...
       //grid.tileTable["A1"][0].UpdateValue(2);
        ...
        answerTable["B"] = grid.tileTable["A"][0].value * 3;
